...
# Filtering for Terms
filtered_df1 = df1[df1['species'].str.contains('Escherichia coli', case=False)]
filtered_df2 = df2[df2['species'].str.contains('Escherichia coli', case=False)]
filtered_df3 = df3[df3['species'].str.contains('Escherichia coli', case=False)]
filtered_df4 = df4[df4['species'].str.contains('Escherichia coli', case=False)]
...
plt.ylabel('Fastq counts for Escherichia coli')
plt.title('Comparison of E.coli Counts Between Samples')
