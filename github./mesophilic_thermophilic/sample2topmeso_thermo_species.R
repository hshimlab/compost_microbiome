...
df_s2 <- purrr::map_dfr(files_s2, \(f) {
...
ggsave(
  "Figure3C_Sample2_Phylum_Threshold50_PERCENT.png",
  p_s2_phylum,
  width = 9,
  height = 5,
  dpi = 300
