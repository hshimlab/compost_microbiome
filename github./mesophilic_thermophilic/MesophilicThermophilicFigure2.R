...
p_s2 <- ggplot(df_sum_s2,
  ...
  scale_color_manual(values = c("Mesophilic" = "#1f78b4",
                                "Thermophilic" = "#b2182b")) +
  labs(
    title = "Sample 2: Temporal changes in mesophilic vs thermophilic species",
    x = "Composting week",
...
ggsave("Figure3C_Sample2_Meso_vs_Thermo.png", p_s2, width = 7, height = 5, dpi = 300)
